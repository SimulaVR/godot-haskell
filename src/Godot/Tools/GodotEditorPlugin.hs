...
pattern CONTAINER_PROJECT_SETTING_TAB_LEFT :: Int

pattern CONTAINER_PROJECT_SETTING_TAB_LEFT = 10
...
pattern CONTAINER_PROJECT_SETTING_TAB_RIGHT :: Int

pattern CONTAINER_PROJECT_SETTING_TAB_RIGHT = 11
