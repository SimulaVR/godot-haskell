...
module Godot.Core.Light
       (Godot.Core.Light._PARAM_SHADOW_NORMAL_BIAS,
        ...
        Godot.Core.Light._PARAM_SPOT_ANGLE,
        Godot.Core.Light.set_editor_only, Godot.Core.Light.is_editor_only,
        Godot.Core.Light.set_param, Godot.Core.Light.get_param,
        Godot.Core.Light.set_shadow, Godot.Core.Light.has_shadow,
        Godot.Core.Light.set_negative, Godot.Core.Light.is_negative,
        Godot.Core.Light.set_cull_mask, Godot.Core.Light.get_cull_mask,
        Godot.Core.Light.set_color, Godot.Core.Light.get_color,
        ...
        Godot.Core.Light.get_shadow_color, Godot.Core.Light.set_bake_mode,
        Godot.Core.Light.get_bake_mode)
       where
import Data.Coerce
import Foreign.C
