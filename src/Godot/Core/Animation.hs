...
module Godot.Core.Animation
       (Godot.Core.Animation._TYPE_BEZIER,
        ...
        Godot.Core.Animation.add_track, Godot.Core.Animation.remove_track,
        ...
        Godot.Core.Animation.find_track,
        ...
        Godot.Core.Animation.set_length, Godot.Core.Animation.get_length,
        Godot.Core.Animation.set_loop, Godot.Core.Animation.has_loop,
        Godot.Core.Animation.set_step, Godot.Core.Animation.get_step,
