...
module Godot.Core.Curve3D
       (Godot.Core.Curve3D.get_point_count, Godot.Core.Curve3D.add_point,
        Godot.Core.Curve3D.set_point_position,
        Godot.Core.Curve3D.get_point_position,
        Godot.Core.Curve3D.set_point_tilt,
        Godot.Core.Curve3D.get_point_tilt, Godot.Core.Curve3D.set_point_in,
        Godot.Core.Curve3D.get_point_in, Godot.Core.Curve3D.set_point_out,
        Godot.Core.Curve3D.get_point_out, Godot.Core.Curve3D.remove_point,
        Godot.Core.Curve3D.clear_points, Godot.Core.Curve3D.interpolate,
        ...
        Godot.Core.Curve3D.tessellate, Godot.Core.Curve3D._get_data,
        Godot.Core.Curve3D._set_data)
       where
import Data.Coerce
import Foreign.C
