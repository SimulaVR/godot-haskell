...
pattern JOY_BUTTON_16 :: Int

pattern JOY_BUTTON_16 = 16

pattern JOY_VR_ANALOG_TRIGGER :: Int

pattern JOY_VR_ANALOG_TRIGGER = 2

pattern KEY_OPENURL :: Int

pattern KEY_OPENURL = 16777301

pattern ERR_CANT_FORK :: Int

pattern ERR_CANT_FORK = 29
...
pattern ERR_INVALID_DECLARATION :: Int

pattern ERR_INVALID_DECLARATION = 41
...
pattern JOY_BUTTON_21 :: Int

pattern JOY_BUTTON_21 = 21
...
pattern JOY_VR_PAD :: Int

pattern JOY_VR_PAD = 14
...
pattern ERR_CONNECTION_ERROR :: Int

pattern ERR_CONNECTION_ERROR = 27
...
pattern JOY_OPENVR_TOUCHPADX :: Int

pattern JOY_OPENVR_TOUCHPADX = 0
...
pattern JOY_VR_GRIP :: Int

pattern JOY_VR_GRIP = 2
...
pattern ERR_CANT_CONNECT :: Int

pattern ERR_CANT_CONNECT = 25
...
pattern ERR_PRINTER_ON_FIRE :: Int

pattern ERR_PRINTER_ON_FIRE = 48
...
pattern JOY_BUTTON_22 :: Int

pattern JOY_BUTTON_22 = 22
...
pattern JOY_PADDLE3 :: Int

pattern JOY_PADDLE3 = 20
...
pattern ERR_CANT_RESOLVE :: Int

pattern ERR_CANT_RESOLVE = 26
...
pattern JOY_TOUCHPAD :: Int

pattern JOY_TOUCHPAD = 22
...
pattern JOY_BUTTON_17 :: Int

pattern JOY_BUTTON_17 = 17
...
pattern JOY_BUTTON_18 :: Int

pattern JOY_BUTTON_18 = 18
...
pattern JOY_VR_TRIGGER :: Int

pattern JOY_VR_TRIGGER = 15
...
pattern JOY_PADDLE1 :: Int

pattern JOY_PADDLE1 = 18
...
pattern JOY_VR_ANALOG_GRIP :: Int

pattern JOY_VR_ANALOG_GRIP = 4
...
pattern JOY_BUTTON_20 :: Int

pattern JOY_BUTTON_20 = 20
...
pattern JOY_INVALID_OPTION :: Int

pattern JOY_INVALID_OPTION = -1
...
pattern JOY_OPENVR_TOUCHPADY :: Int

pattern JOY_OPENVR_TOUCHPADY = 1
...
pattern JOY_OPENVR_MENU :: Int

pattern JOY_OPENVR_MENU = 1
...
pattern JOY_OCULUS_BY :: Int

pattern JOY_OCULUS_BY = 1
...
pattern JOY_OCULUS_AX :: Int

pattern JOY_OCULUS_AX = 7
...
pattern JOY_GUIDE :: Int

pattern JOY_GUIDE = 16

pattern ERR_INVALID_PARAMETER :: Int

pattern ERR_INVALID_PARAMETER = 31

pattern JOY_PADDLE4 :: Int

pattern JOY_PADDLE4 = 21
...
pattern JOY_BUTTON_19 :: Int

pattern JOY_BUTTON_19 = 19
...
pattern JOY_OCULUS_MENU :: Int

pattern JOY_OCULUS_MENU = 3
...
pattern JOY_MISC1 :: Int

pattern JOY_MISC1 = 17
...
pattern JOY_PADDLE2 :: Int

pattern JOY_PADDLE2 = 19

pattern ERR_DUPLICATE_SYMBOL :: Int

pattern ERR_DUPLICATE_SYMBOL = 42
