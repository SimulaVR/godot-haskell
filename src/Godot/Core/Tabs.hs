...
module Godot.Core.Tabs
       (Godot.Core.Tabs._ALIGN_RIGHT,
        ...
        Godot.Core.Tabs.sig_tab_close, Godot.Core.Tabs.sig_tab_clicked,
        Godot.Core.Tabs.sig_reposition_active_tab_request,
        Godot.Core.Tabs.sig_right_button_pressed,
        Godot.Core.Tabs.sig_tab_changed, Godot.Core.Tabs.sig_tab_hover,
        Godot.Core.Tabs._gui_input, Godot.Core.Tabs._update_hover,
        Godot.Core.Tabs.get_tab_count, Godot.Core.Tabs.set_current_tab,
        Godot.Core.Tabs.get_current_tab, Godot.Core.Tabs.set_tab_title,
        Godot.Core.Tabs.get_tab_title, Godot.Core.Tabs.set_tab_icon,
        Godot.Core.Tabs.get_tab_icon, Godot.Core.Tabs.set_tab_disabled,
        Godot.Core.Tabs.get_tab_disabled, Godot.Core.Tabs.remove_tab,
        Godot.Core.Tabs.add_tab, Godot.Core.Tabs.set_tab_align,
        Godot.Core.Tabs.get_tab_align, Godot.Core.Tabs.get_tab_offset,
        Godot.Core.Tabs.get_offset_buttons_visible,
        Godot.Core.Tabs.ensure_tab_visible, Godot.Core.Tabs.get_tab_rect,
        Godot.Core.Tabs.move_tab,
        ...
        Godot.Core.Tabs.set_select_with_rmb,
