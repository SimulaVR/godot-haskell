...
module Godot.Core.PathFollow
       (Godot.Core.PathFollow._ROTATION_ORIENTED,
        ...
        Godot.Core.PathFollow.set_offset, Godot.Core.PathFollow.get_offset,
        Godot.Core.PathFollow.set_h_offset,
        Godot.Core.PathFollow.get_h_offset,
        Godot.Core.PathFollow.set_v_offset,
        Godot.Core.PathFollow.get_v_offset,
        ...
        Godot.Core.PathFollow.set_loop, Godot.Core.PathFollow.has_loop)
       where
import Data.Coerce
import Foreign.C
