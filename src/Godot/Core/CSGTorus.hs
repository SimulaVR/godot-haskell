...
module Godot.Core.CSGTorus
       (Godot.Core.CSGTorus.set_inner_radius,
        ...
        Godot.Core.CSGTorus.set_sides, Godot.Core.CSGTorus.get_sides,
        Godot.Core.CSGTorus.set_ring_sides,
        Godot.Core.CSGTorus.get_ring_sides,
        Godot.Core.CSGTorus.set_material, Godot.Core.CSGTorus.get_material,
