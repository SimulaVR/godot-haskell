...
module Godot.Core.VisualServer
       (Godot.Core.VisualServer._ARRAY_COMPRESS_WEIGHTS,
        ...
        Godot.Core.VisualServer.force_draw, Godot.Core.VisualServer.sync,
        ...
        Godot.Core.VisualServer.has_changed, Godot.Core.VisualServer.init,
        Godot.Core.VisualServer.finish,
...
canvas_item_add_mesh cls arg1 arg2 arg3 arg4
  = withVariantArray
      [toVariant arg1, toVariant arg2, toVariant arg3, toVariant arg4]
      (\ (arrPtr, len) ->
...
set_boot_image ::
                 (VisualServer :< cls, Object :< cls) =>
                 cls -> Image -> Color -> Bool -> IO ()
set_boot_image cls arg1 arg2 arg3
  = withVariantArray [toVariant arg1, toVariant arg2, toVariant arg3]
      (\ (arrPtr, len) ->
