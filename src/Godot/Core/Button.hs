...
module Godot.Core.Button
       (Godot.Core.Button._ALIGN_RIGHT, Godot.Core.Button._ALIGN_LEFT,
        Godot.Core.Button._ALIGN_CENTER, Godot.Core.Button.set_text,
        Godot.Core.Button.get_text, Godot.Core.Button.set_button_icon,
        Godot.Core.Button.get_button_icon, Godot.Core.Button.set_flat,
        Godot.Core.Button.set_clip_text, Godot.Core.Button.get_clip_text,
        Godot.Core.Button.set_text_align, Godot.Core.Button.get_text_align,
        Godot.Core.Button.is_flat)
       where
import Data.Coerce
import Foreign.C
