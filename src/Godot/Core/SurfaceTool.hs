...
module Godot.Core.SurfaceTool
       (Godot.Core.SurfaceTool.begin, Godot.Core.SurfaceTool.add_vertex,
        Godot.Core.SurfaceTool.add_color,
        Godot.Core.SurfaceTool.add_normal,
        Godot.Core.SurfaceTool.add_tangent, Godot.Core.SurfaceTool.add_uv,
        Godot.Core.SurfaceTool.add_uv2, Godot.Core.SurfaceTool.add_bones,
        Godot.Core.SurfaceTool.add_weights,
        Godot.Core.SurfaceTool.add_smooth_group,
        Godot.Core.SurfaceTool.add_triangle_fan,
        Godot.Core.SurfaceTool.add_index, Godot.Core.SurfaceTool.index,
        Godot.Core.SurfaceTool.deindex,
        Godot.Core.SurfaceTool.generate_normals,
        Godot.Core.SurfaceTool.generate_tangents,
        Godot.Core.SurfaceTool.set_material, Godot.Core.SurfaceTool.clear,
        Godot.Core.SurfaceTool.create_from,
        Godot.Core.SurfaceTool.append_from, Godot.Core.SurfaceTool.commit)
       where
import Data.Coerce
import Foreign.C
