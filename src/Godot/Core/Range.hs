...
module Godot.Core.Range
       (Godot.Core.Range.sig_value_changed, Godot.Core.Range.sig_changed,
        Godot.Core.Range.get_value, Godot.Core.Range.get_min,
        Godot.Core.Range.get_max, Godot.Core.Range.get_step,
        Godot.Core.Range.get_page, Godot.Core.Range.get_as_ratio,
        Godot.Core.Range.set_value, Godot.Core.Range.set_min,
        Godot.Core.Range.set_max, Godot.Core.Range.set_step,
        Godot.Core.Range.set_page, Godot.Core.Range.set_as_ratio,
        Godot.Core.Range.set_use_rounded_values,
        Godot.Core.Range.is_using_rounded_values,
        Godot.Core.Range.set_exp_ratio, Godot.Core.Range.is_ratio_exp,
        Godot.Core.Range.set_allow_greater,
        Godot.Core.Range.is_greater_allowed,
        Godot.Core.Range.set_allow_lesser,
        Godot.Core.Range.is_lesser_allowed, Godot.Core.Range.share,
