...
module Godot.Core.AudioServer
       (Godot.Core.AudioServer._SPEAKER_SURROUND_71,
        ...
        Godot.Core.AudioServer.remove_bus, Godot.Core.AudioServer.add_bus,
        Godot.Core.AudioServer.move_bus,
        ...
        Godot.Core.AudioServer.is_bus_solo,
        ...
        Godot.Core.AudioServer.lock, Godot.Core.AudioServer.unlock,
