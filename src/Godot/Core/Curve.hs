...
module Godot.Core.Curve
       (Godot.Core.Curve._TANGENT_LINEAR, Godot.Core.Curve._TANGENT_FREE,
        ...
        Godot.Core.Curve.sig_range_changed,
        Godot.Core.Curve.get_point_count, Godot.Core.Curve.add_point,
        Godot.Core.Curve.remove_point, Godot.Core.Curve.clear_points,
        Godot.Core.Curve.get_point_position,
        Godot.Core.Curve.set_point_value,
        Godot.Core.Curve.set_point_offset, Godot.Core.Curve.interpolate,
        Godot.Core.Curve.interpolate_baked,
        ...
        Godot.Core.Curve.get_min_value, Godot.Core.Curve.set_min_value,
        Godot.Core.Curve.get_max_value, Godot.Core.Curve.set_max_value,
        Godot.Core.Curve.clean_dupes, Godot.Core.Curve.bake,
        Godot.Core.Curve.get_bake_resolution,
        Godot.Core.Curve.set_bake_resolution, Godot.Core.Curve._get_data,
        Godot.Core.Curve._set_data)
       where
import Data.Coerce
import Foreign.C
