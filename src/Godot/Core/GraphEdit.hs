...
module Godot.Core.GraphEdit
       (Godot.Core.GraphEdit.sig_delete_nodes_request,
        ...
        Godot.Core.GraphEdit.get_scroll_ofs,
        ...
        Godot.Core.GraphEdit.set_zoom, Godot.Core.GraphEdit.get_zoom,
        Godot.Core.GraphEdit.set_snap, Godot.Core.GraphEdit.get_snap,
        Godot.Core.GraphEdit.set_use_snap,
        ...
        Godot.Core.GraphEdit._zoom_minus, Godot.Core.GraphEdit._zoom_reset,
        Godot.Core.GraphEdit._zoom_plus,
        ...
        Godot.Core.GraphEdit.get_zoom_hbox,
