...
module Godot.Core.Control
       (Godot.Core.Control._NOTIFICATION_MOUSE_EXIT,
        ...
        Godot.Core.Control.sig_focus_exited, Godot.Core.Control._gui_input,
        Godot.Core.Control._get_minimum_size,
        Godot.Core.Control.get_drag_data, Godot.Core.Control.can_drop_data,
        Godot.Core.Control.drop_data,
        Godot.Core.Control._make_custom_tooltip,
        Godot.Core.Control._clips_input, Godot.Core.Control.has_point,
        Godot.Core.Control._size_changed,
        Godot.Core.Control._update_minimum_size,
        Godot.Core.Control.accept_event,
        Godot.Core.Control.get_minimum_size,
        ...
        Godot.Core.Control.set_anchor, Godot.Core.Control._set_anchor,
        Godot.Core.Control.get_anchor, Godot.Core.Control.set_margin,
        Godot.Core.Control.set_anchor_and_margin,
        Godot.Core.Control.set_begin, Godot.Core.Control.set_end,
        Godot.Core.Control.set_position, Godot.Core.Control.set_size,
        Godot.Core.Control.set_custom_minimum_size,
        Godot.Core.Control.set_global_position,
        Godot.Core.Control.set_rotation,
        Godot.Core.Control.set_rotation_degrees,
        Godot.Core.Control.set_scale, Godot.Core.Control.set_pivot_offset,
        Godot.Core.Control.get_margin, Godot.Core.Control.get_begin,
        Godot.Core.Control.get_end, Godot.Core.Control.get_position,
        Godot.Core.Control.get_size, Godot.Core.Control.get_rotation,
        Godot.Core.Control.get_rotation_degrees,
        Godot.Core.Control.get_scale, Godot.Core.Control.get_pivot_offset,
        Godot.Core.Control.get_custom_minimum_size,
        Godot.Core.Control.get_parent_area_size,
        Godot.Core.Control.get_global_position,
        Godot.Core.Control.get_rect, Godot.Core.Control.get_global_rect,
        Godot.Core.Control.show_modal, Godot.Core.Control.set_focus_mode,
        Godot.Core.Control.get_focus_mode, Godot.Core.Control.has_focus,
        Godot.Core.Control.grab_focus, Godot.Core.Control.release_focus,
        Godot.Core.Control.get_focus_owner,
        Godot.Core.Control.set_h_size_flags,
        Godot.Core.Control.get_h_size_flags,
        Godot.Core.Control.set_stretch_ratio,
        Godot.Core.Control.get_stretch_ratio,
        Godot.Core.Control.set_v_size_flags,
        Godot.Core.Control.get_v_size_flags, Godot.Core.Control.set_theme,
        Godot.Core.Control.get_theme, Godot.Core.Control.add_icon_override,
        ...
        Godot.Core.Control.get_icon, Godot.Core.Control.get_stylebox,
        Godot.Core.Control.get_font, Godot.Core.Control.get_color,
        Godot.Core.Control.get_constant,
        Godot.Core.Control.has_icon_override,
        Godot.Core.Control.has_shader_override,
        Godot.Core.Control.has_stylebox_override,
        Godot.Core.Control.has_font_override,
        Godot.Core.Control.has_color_override,
        Godot.Core.Control.has_constant_override,
        Godot.Core.Control.has_icon, Godot.Core.Control.has_stylebox,
        Godot.Core.Control.has_font, Godot.Core.Control.has_color,
        ...
        Godot.Core.Control.set_tooltip, Godot.Core.Control.get_tooltip,
        Godot.Core.Control._get_tooltip,
        ...
        Godot.Core.Control.get_focus_previous,
        Godot.Core.Control.force_drag, Godot.Core.Control.set_mouse_filter,
        Godot.Core.Control.get_mouse_filter,
        Godot.Core.Control.set_clip_contents,
        Godot.Core.Control.is_clipping_contents,
        Godot.Core.Control.grab_click_focus,
        Godot.Core.Control.set_drag_forwarding,
        Godot.Core.Control.set_drag_preview, Godot.Core.Control.warp_mouse,
...
--   				[/codeblock]
get_drag_data ::
                (Control :< cls, Object :< cls) => cls -> Vector2 -> IO Object
