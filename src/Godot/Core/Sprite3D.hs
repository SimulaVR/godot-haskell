...
module Godot.Core.Sprite3D
       (Godot.Core.Sprite3D.sig_frame_changed,
        Godot.Core.Sprite3D.set_texture, Godot.Core.Sprite3D.get_texture,
        Godot.Core.Sprite3D.set_region, Godot.Core.Sprite3D.is_region,
        Godot.Core.Sprite3D.set_region_rect,
        Godot.Core.Sprite3D.get_region_rect, Godot.Core.Sprite3D.set_frame,
        Godot.Core.Sprite3D.get_frame, Godot.Core.Sprite3D.set_vframes,
        Godot.Core.Sprite3D.get_vframes, Godot.Core.Sprite3D.set_hframes,
