...
module Godot.Core.Input
       (Godot.Core.Input._CURSOR_MOVE, Godot.Core.Input._CURSOR_ARROW,
        ...
        Godot.Core.Input.is_joy_known, Godot.Core.Input.get_joy_axis,
        Godot.Core.Input.get_joy_name, Godot.Core.Input.get_joy_guid,
        ...
        Godot.Core.Input.stop_joy_vibration, Godot.Core.Input.get_gravity,
        Godot.Core.Input.get_accelerometer,
        Godot.Core.Input.get_magnetometer, Godot.Core.Input.get_gyroscope,
        Godot.Core.Input.get_last_mouse_speed,
        Godot.Core.Input.get_mouse_button_mask,
        Godot.Core.Input.set_mouse_mode, Godot.Core.Input.get_mouse_mode,
