...
module Godot.Core.BaseButton
       (Godot.Core.BaseButton._DRAW_NORMAL,
        ...
        Godot.Core.BaseButton._pressed, Godot.Core.BaseButton._toggled,
        Godot.Core.BaseButton._gui_input,
        Godot.Core.BaseButton._unhandled_input,
        Godot.Core.BaseButton.set_pressed,
        Godot.Core.BaseButton.is_pressed, Godot.Core.BaseButton.is_hovered,
