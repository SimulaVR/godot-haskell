...
pattern FLAG_TRIPLANAR_USE_WORLD = 9
...
pattern FLAG_USE_ALPHA_SCISSOR = 12
...
pattern FLAG_EMISSION_ON_UV2 = 11

pattern FLAG_AO_ON_UV2 :: Int

pattern FLAG_AO_ON_UV2 = 10
...
pattern FLAG_UV1_USE_TRIPLANAR = 7
...
pattern FLAG_ALBEDO_TEXTURE_FORCE_SRGB = 13
...
pattern FLAG_UV2_USE_TRIPLANAR = 8
