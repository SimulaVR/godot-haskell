...
module Godot.Core.Tree
       (Godot.Core.Tree._DROP_MODE_DISABLED, Godot.Core.Tree._SELECT_ROW,
        ...
        Godot.Core.Tree._SELECT_SINGLE, Godot.Core.Tree.sig_item_activated,
        ...
        Godot.Core.Tree.sig_nothing_selected,
        ...
        Godot.Core.Tree._range_click_timeout, Godot.Core.Tree._gui_input,
        Godot.Core.Tree._popup_select, Godot.Core.Tree._text_editor_enter,
        Godot.Core.Tree._text_editor_modal_close,
        Godot.Core.Tree._value_editor_changed,
        Godot.Core.Tree._scroll_moved, Godot.Core.Tree.clear,
        Godot.Core.Tree.create_item, Godot.Core.Tree.get_root,
        Godot.Core.Tree.set_column_min_width,
        Godot.Core.Tree.set_column_expand,
        Godot.Core.Tree.get_column_width, Godot.Core.Tree.set_hide_root,
        Godot.Core.Tree.is_root_hidden, Godot.Core.Tree.get_next_selected,
        Godot.Core.Tree.get_selected, Godot.Core.Tree.get_selected_column,
        Godot.Core.Tree.get_pressed_button,
        Godot.Core.Tree.set_select_mode, Godot.Core.Tree.get_select_mode,
        Godot.Core.Tree.set_columns, Godot.Core.Tree.get_columns,
        Godot.Core.Tree.get_edited, Godot.Core.Tree.get_edited_column,
        Godot.Core.Tree.get_custom_popup_rect,
        ...
        Godot.Core.Tree.are_column_titles_visible,
        Godot.Core.Tree.set_column_title, Godot.Core.Tree.get_column_title,
        Godot.Core.Tree.get_scroll, Godot.Core.Tree.set_hide_folding,
        Godot.Core.Tree.is_folding_hidden,
        Godot.Core.Tree.set_drop_mode_flags,
