...
module Godot.Core.Camera2D
       (Godot.Core.Camera2D._ANCHOR_MODE_FIXED_TOP_LEFT,
        ...
        Godot.Core.Camera2D.set_offset, Godot.Core.Camera2D.get_offset,
        Godot.Core.Camera2D.set_anchor_mode,
        Godot.Core.Camera2D.get_anchor_mode,
        Godot.Core.Camera2D.set_rotating, Godot.Core.Camera2D.is_rotating,
        Godot.Core.Camera2D.make_current,
        Godot.Core.Camera2D.clear_current,
        Godot.Core.Camera2D._make_current,
        Godot.Core.Camera2D._update_scroll,
        Godot.Core.Camera2D.set_process_mode,
        Godot.Core.Camera2D.get_process_mode,
        Godot.Core.Camera2D._set_current, Godot.Core.Camera2D.is_current,
        Godot.Core.Camera2D.set_limit, Godot.Core.Camera2D.get_limit,
        ...
        Godot.Core.Camera2D.set_v_offset, Godot.Core.Camera2D.get_v_offset,
        Godot.Core.Camera2D.set_h_offset, Godot.Core.Camera2D.get_h_offset,
        ...
        Godot.Core.Camera2D.set_zoom, Godot.Core.Camera2D.get_zoom,
        ...
        Godot.Core.Camera2D.reset_smoothing, Godot.Core.Camera2D.align,
