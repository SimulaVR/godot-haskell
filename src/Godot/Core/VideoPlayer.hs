...
module Godot.Core.VideoPlayer
       (Godot.Core.VideoPlayer.sig_finished,
        ...
        Godot.Core.VideoPlayer.get_stream, Godot.Core.VideoPlayer.play,
        Godot.Core.VideoPlayer.stop, Godot.Core.VideoPlayer.is_playing,
        ...
        Godot.Core.VideoPlayer.set_volume_db,
