...
module Godot.Core.Polygon2D
       (Godot.Core.Polygon2D.set_polygon,
        Godot.Core.Polygon2D.get_polygon, Godot.Core.Polygon2D.set_uv,
        Godot.Core.Polygon2D.get_uv, Godot.Core.Polygon2D.set_color,
        Godot.Core.Polygon2D.get_color, Godot.Core.Polygon2D.set_polygons,
        Godot.Core.Polygon2D.get_polygons,
        Godot.Core.Polygon2D.set_vertex_colors,
        Godot.Core.Polygon2D.get_vertex_colors,
        Godot.Core.Polygon2D.set_texture, Godot.Core.Polygon2D.get_texture,
        ...
        Godot.Core.Polygon2D.set_invert, Godot.Core.Polygon2D.get_invert,
        ...
        Godot.Core.Polygon2D.set_offset, Godot.Core.Polygon2D.get_offset,
        Godot.Core.Polygon2D.add_bone, Godot.Core.Polygon2D.get_bone_count,
        Godot.Core.Polygon2D.get_bone_path,
        Godot.Core.Polygon2D.get_bone_weights,
        Godot.Core.Polygon2D.erase_bone, Godot.Core.Polygon2D.clear_bones,
        ...
        Godot.Core.Polygon2D._set_bones, Godot.Core.Polygon2D._get_bones,
