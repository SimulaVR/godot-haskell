...
module Godot.Core.Particles
       (Godot.Core.Particles._MAX_DRAW_PASSES,
        ...
        Godot.Core.Particles.set_emitting, Godot.Core.Particles.set_amount,
        ...
        Godot.Core.Particles.is_emitting, Godot.Core.Particles.get_amount,
        ...
        Godot.Core.Particles.restart, Godot.Core.Particles.capture_aabb)
       where
import Data.Coerce
import Foreign.C
