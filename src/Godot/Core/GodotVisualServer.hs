...
pattern LIGHT_PARAM_SHADOW_MAX_DISTANCE = 9
...
pattern VIEWPORT_RENDER_INFO_MAX = 8
...
pattern VIEWPORT_RENDER_INFO_2D_DRAW_CALLS_IN_FRAME :: Int

pattern VIEWPORT_RENDER_INFO_2D_DRAW_CALLS_IN_FRAME = 7
...
pattern VIEWPORT_RENDER_INFO_2D_ITEMS_IN_FRAME :: Int

pattern VIEWPORT_RENDER_INFO_2D_ITEMS_IN_FRAME = 6

pattern FEATURE_SHADERS :: Int

pattern FEATURE_SHADERS = 0

pattern LIGHT_BAKE_ALL :: Int

pattern LIGHT_BAKE_ALL = 2
...
pattern LIGHT_PARAM_SHADOW_BIAS = 14

pattern VIEWPORT_MSAA_EXT_4X :: Int

pattern VIEWPORT_MSAA_EXT_4X = 6
...
pattern ARRAY_COMPRESS_DEFAULT = 2194432

pattern VIEWPORT_MSAA_EXT_2X :: Int

pattern VIEWPORT_MSAA_EXT_2X = 5

pattern LIGHT_PARAM_SHADOW_BIAS_SPLIT_SCALE :: Int

pattern LIGHT_PARAM_SHADOW_BIAS_SPLIT_SCALE = 15
...
pattern ENV_TONE_MAPPER_ACES_FITTED :: Int

pattern ENV_TONE_MAPPER_ACES_FITTED = 4
...
pattern LIGHT_PARAM_SHADOW_SPLIT_3_OFFSET = 12
...
pattern LIGHT_PARAM_SIZE :: Int

pattern LIGHT_PARAM_SIZE = 2

pattern ARRAY_FLAG_USE_OCTAHEDRAL_COMPRESSION :: Int

pattern ARRAY_FLAG_USE_OCTAHEDRAL_COMPRESSION = 2097152
...
pattern INFO_TEXTURE_MEM_USED = 10
...
pattern INFO_2D_DRAW_CALLS_IN_FRAME :: Int

pattern INFO_2D_DRAW_CALLS_IN_FRAME = 7
...
pattern LIGHT_PARAM_ATTENUATION = 5
...
pattern LIGHT_PARAM_SPOT_ANGLE = 6
...
pattern LIGHT_PARAM_SHADOW_SPLIT_1_OFFSET = 10
...
pattern LIGHT_PARAM_SHADOW_SPLIT_2_OFFSET = 11
...
pattern LIGHT_PARAM_SPECULAR = 3

pattern SHADER_SPATIAL :: Int

pattern SHADER_SPATIAL = 0

pattern INFO_2D_ITEMS_IN_FRAME :: Int

pattern INFO_2D_ITEMS_IN_FRAME = 6

pattern VIEWPORT_RENDER_INFO_VERTICES_IN_FRAME :: Int

pattern VIEWPORT_RENDER_INFO_VERTICES_IN_FRAME = 1

pattern LIGHT_BAKE_DISABLED :: Int

pattern LIGHT_BAKE_DISABLED = 0
...
pattern LIGHT_PARAM_CONTACT_SHADOW_SIZE = 8
...
pattern LIGHT_BAKE_INDIRECT :: Int

pattern LIGHT_BAKE_INDIRECT = 1
...
pattern TEXTURE_TYPE_CUBEMAP = 2
...
pattern LIGHT_PARAM_SHADOW_NORMAL_BIAS = 13
...
pattern TEXTURE_TYPE_2D_ARRAY = 3
...
pattern LIGHT_PARAM_INDIRECT_ENERGY :: Int

pattern LIGHT_PARAM_INDIRECT_ENERGY = 1

pattern INFO_USAGE_VIDEO_MEM_TOTAL :: Int

pattern INFO_USAGE_VIDEO_MEM_TOTAL = 8
...
pattern INFO_VERTEX_MEM_USED = 11
...
pattern LIGHT_PARAM_SPOT_ATTENUATION = 7
