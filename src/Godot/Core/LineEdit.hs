...
module Godot.Core.LineEdit
       (Godot.Core.LineEdit._MENU_PASTE, Godot.Core.LineEdit._ALIGN_RIGHT,
        ...
        Godot.Core.LineEdit.get_focus_mode,
        Godot.Core.LineEdit.set_focus_mode,
        Godot.Core.LineEdit._text_changed,
        Godot.Core.LineEdit._toggle_draw_caret,
        Godot.Core.LineEdit._editor_settings_changed,
        Godot.Core.LineEdit.set_align, Godot.Core.LineEdit.get_align,
        Godot.Core.LineEdit._gui_input, Godot.Core.LineEdit.clear,
        Godot.Core.LineEdit.select, Godot.Core.LineEdit.select_all,
        Godot.Core.LineEdit.deselect, Godot.Core.LineEdit.set_text,
        Godot.Core.LineEdit.get_text, Godot.Core.LineEdit.set_placeholder,
        ...
        Godot.Core.LineEdit.get_max_length,
        Godot.Core.LineEdit.append_at_cursor,
        Godot.Core.LineEdit.set_editable, Godot.Core.LineEdit.is_editable,
        Godot.Core.LineEdit.set_secret, Godot.Core.LineEdit.is_secret,
        Godot.Core.LineEdit.set_secret_character,
        Godot.Core.LineEdit.get_secret_character,
        Godot.Core.LineEdit.menu_option, Godot.Core.LineEdit.get_menu,
...
bindLineEdit_get_focus_mode :: MethodBind
...
-- | Defines how the [code]LineEdit[/code] can grab focus (Keyboard and mouse, only keyboard, or none). See [code]enum FocusMode[/code] in [Control] for details.
get_focus_mode :: (LineEdit :< cls, Object :< cls) => cls -> IO Int
get_focus_mode cls
  = withVariantArray []
      (\ (arrPtr, len) ->
         godot_method_bind_call bindLineEdit_get_focus_mode (upcast cls)
           arrPtr
           len
...
-- | Defines how the [code]LineEdit[/code] can grab focus (Keyboard and mouse, only keyboard, or none). See [code]enum FocusMode[/code] in [Control] for details.
bindLineEdit_set_focus_mode :: MethodBind
...
set_focus_mode cls arg1
  = withVariantArray [toVariant arg1]
      (\ (arrPtr, len) ->
         godot_method_bind_call bindLineEdit_set_focus_mode (upcast cls)
           arrPtr
           len
           >>= \ (err, res) -> throwIfErr err >> fromGodotVariant res)
