...
module Godot.Core.CSGBox
       (Godot.Core.CSGBox.set_width, Godot.Core.CSGBox.get_width,
        Godot.Core.CSGBox.set_height, Godot.Core.CSGBox.get_height,
        Godot.Core.CSGBox.set_depth, Godot.Core.CSGBox.get_depth,
        Godot.Core.CSGBox.set_material, Godot.Core.CSGBox.get_material)
       where
import Data.Coerce
import Foreign.C
