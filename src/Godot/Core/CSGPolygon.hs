...
module Godot.Core.CSGPolygon
       (Godot.Core.CSGPolygon._MODE_PATH,
        ...
        Godot.Core.CSGPolygon.get_polygon, Godot.Core.CSGPolygon.set_mode,
        Godot.Core.CSGPolygon.get_mode, Godot.Core.CSGPolygon.set_depth,
        ...
        Godot.Core.CSGPolygon.set_material,
        Godot.Core.CSGPolygon.get_material,
