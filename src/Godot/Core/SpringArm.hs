...
module Godot.Core.SpringArm
       (Godot.Core.SpringArm.get_hit_length,
        Godot.Core.SpringArm.set_length, Godot.Core.SpringArm.get_length,
        Godot.Core.SpringArm.set_shape, Godot.Core.SpringArm.get_shape,
        ...
        Godot.Core.SpringArm.set_margin, Godot.Core.SpringArm.get_margin)
       where
import Data.Coerce
import Foreign.C
