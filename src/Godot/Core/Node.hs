...
module Godot.Core.Node
       (Godot.Core.Node._DUPLICATE_GROUPS,
        ...
        Godot.Core.Node._NOTIFICATION_READY, Godot.Core.Node.sig_renamed,
        Godot.Core.Node.sig_ready, Godot.Core.Node.sig_tree_entered,
        Godot.Core.Node.sig_tree_exiting, Godot.Core.Node.sig_tree_exited,
        Godot.Core.Node._process, Godot.Core.Node._physics_process,
        Godot.Core.Node._enter_tree, Godot.Core.Node._exit_tree,
        Godot.Core.Node._ready, Godot.Core.Node._input,
        Godot.Core.Node._unhandled_input,
        Godot.Core.Node._unhandled_key_input,
        Godot.Core.Node._get_configuration_warning,
        Godot.Core.Node.add_child_below_node, Godot.Core.Node.set_name,
        Godot.Core.Node.get_name, Godot.Core.Node.add_child,
        Godot.Core.Node.remove_child, Godot.Core.Node.get_child_count,
        Godot.Core.Node.get_children, Godot.Core.Node.get_child,
        Godot.Core.Node.has_node, Godot.Core.Node.get_node,
        Godot.Core.Node.get_node_or_null, Godot.Core.Node.get_parent,
        Godot.Core.Node.find_node, Godot.Core.Node.find_parent,
        Godot.Core.Node.has_node_and_resource,
        Godot.Core.Node.get_node_and_resource,
        Godot.Core.Node.is_inside_tree, Godot.Core.Node.is_a_parent_of,
        Godot.Core.Node.is_greater_than, Godot.Core.Node.get_path,
        Godot.Core.Node.get_path_to, Godot.Core.Node.add_to_group,
        Godot.Core.Node.remove_from_group, Godot.Core.Node.is_in_group,
        Godot.Core.Node.move_child, Godot.Core.Node.get_groups,
        Godot.Core.Node.raise, Godot.Core.Node.set_owner,
        Godot.Core.Node.get_owner, Godot.Core.Node.remove_and_skip,
        Godot.Core.Node.get_index, Godot.Core.Node.print_tree,
        Godot.Core.Node.print_tree_pretty, Godot.Core.Node.set_filename,
        Godot.Core.Node.get_filename,
        Godot.Core.Node.propagate_notification,
        ...
        Godot.Core.Node.set_process, Godot.Core.Node.set_process_priority,
        Godot.Core.Node.is_processing, Godot.Core.Node.set_process_input,
        Godot.Core.Node.is_processing_input,
        ...
        Godot.Core.Node.set_pause_mode, Godot.Core.Node.get_pause_mode,
        Godot.Core.Node.can_process, Godot.Core.Node.print_stray_nodes,
        ...
        Godot.Core.Node.get_tree, Godot.Core.Node.duplicate,
        Godot.Core.Node.replace_by,
        Godot.Core.Node.set_scene_instance_load_placeholder,
        Godot.Core.Node.get_scene_instance_load_placeholder,
        Godot.Core.Node.get_viewport, Godot.Core.Node.queue_free,
        Godot.Core.Node.request_ready, Godot.Core.Node.set_network_master,
        Godot.Core.Node.get_network_master,
        Godot.Core.Node.is_network_master, Godot.Core.Node.get_multiplayer,
        Godot.Core.Node.get_custom_multiplayer,
        Godot.Core.Node.set_custom_multiplayer, Godot.Core.Node.rpc_config,
        Godot.Core.Node.rset_config, Godot.Core.Node._set_import_path,
        Godot.Core.Node._get_import_path, Godot.Core.Node.rpc,
        Godot.Core.Node.rpc_unreliable, Godot.Core.Node.rpc_id,
...
_NOTIFICATION_TRANSLATION_CHANGED = 24
