...
module Godot.Core.Theme
       (Godot.Core.Theme.set_icon, Godot.Core.Theme.get_icon,
        Godot.Core.Theme.has_icon, Godot.Core.Theme.clear_icon,
        Godot.Core.Theme.get_icon_list, Godot.Core.Theme.set_stylebox,
        Godot.Core.Theme.get_stylebox, Godot.Core.Theme.has_stylebox,
        Godot.Core.Theme.clear_stylebox,
        Godot.Core.Theme.get_stylebox_list,
        Godot.Core.Theme.get_stylebox_types, Godot.Core.Theme.set_font,
        Godot.Core.Theme.get_font, Godot.Core.Theme.has_font,
        Godot.Core.Theme.clear_font, Godot.Core.Theme.get_font_list,
        Godot.Core.Theme.set_color, Godot.Core.Theme.get_color,
        Godot.Core.Theme.has_color, Godot.Core.Theme.clear_color,
        Godot.Core.Theme.get_color_list, Godot.Core.Theme.set_constant,
        Godot.Core.Theme.get_constant, Godot.Core.Theme.has_constant,
        Godot.Core.Theme.clear_constant,
        Godot.Core.Theme.get_constant_list, Godot.Core.Theme.clear,
        Godot.Core.Theme.set_default_font,
        Godot.Core.Theme.get_default_font, Godot.Core.Theme.get_type_list,
        Godot.Core.Theme._emit_theme_changed,
