...
module Godot.Core.HingeJoint
       (Godot.Core.HingeJoint._PARAM_MOTOR_MAX_IMPULSE,
        ...
        Godot.Core.HingeJoint._PARAM_BIAS, Godot.Core.HingeJoint.set_param,
        Godot.Core.HingeJoint.get_param, Godot.Core.HingeJoint.set_flag,
        Godot.Core.HingeJoint.get_flag,
