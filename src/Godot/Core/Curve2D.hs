...
module Godot.Core.Curve2D
       (Godot.Core.Curve2D.get_point_count, Godot.Core.Curve2D.add_point,
        Godot.Core.Curve2D.set_point_position,
        Godot.Core.Curve2D.get_point_position,
        Godot.Core.Curve2D.set_point_in, Godot.Core.Curve2D.get_point_in,
        Godot.Core.Curve2D.set_point_out, Godot.Core.Curve2D.get_point_out,
        Godot.Core.Curve2D.remove_point, Godot.Core.Curve2D.clear_points,
        Godot.Core.Curve2D.interpolate, Godot.Core.Curve2D.interpolatef,
        ...
        Godot.Core.Curve2D.tessellate, Godot.Core.Curve2D._get_data,
        Godot.Core.Curve2D._set_data)
       where
import Data.Coerce
import Foreign.C
